                    ...
                    <table align="center" width="900px" cellspacing="4" cellpadding="4" style="text-align: center">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><a href="Role.php?id=<?php echo $row["roleid"]; ?>" id="abc">Edit</a></td>
                                <td><button type="submit" value="<?php echo $row["roleid"]; ?>" name="delete">Delete</button></td>
                            </tr>
...
?>
                    ...
                    <button type="submit" name="create">Create new Role</button>
                </div>
