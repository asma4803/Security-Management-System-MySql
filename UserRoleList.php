        ...
        <div class="container">
            <form action="" method="POST">
                <div class="login-box">
                    ...
                    <table align="center" width="700px" cellspacing="4" cellpadding="4" style="text-align: center">
                        <tr>
                            <th>User</th>
                            <th>Role</th>
                            <th>Edit</th>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                <td><?php echo $user; ?></td>
                                <td><?php echo $role; ?></td>
                                <td><a href="UserRole.php?id=<?php echo  $row["id"]; ?>" id="abc">Edit</a></td>
...
?>
                    ...
                    <button type="submit" name="create">Create new user-role</button>
                </div>
